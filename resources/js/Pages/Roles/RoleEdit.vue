    ...
    <div class="w-full justify-center py-12 container mx-auto">
        <div class="bg-white rounded shadow overflow-hidden justify-center">
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form @submit.prevent="store(role)">
                    <div class="">
                        <div class="mb-4">

                           <br>

                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-4" id="exampleFormControlInput1" placeholder="Enter Name" v-model="role.name" required>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                            <button @click.prevent="deleteRole(data)" tabindex="-1" class="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-red-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-red-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green transition ease-in-out duration-150 sm:text-sm sm:leading-5"  >
                                Delete
                            </button>
                        </span>
...
export default {
    ...
    props: ['data'],
        ...
        created() {
            axios.get(this.route('roles-api.show',this.data.id))
                 .then((response) => {
    ...
    methods: {
        ...
        store(data) {
            ...
            axios.put(this.route('roles-api.update', data.id),data)
            .then(response => {
                this.showAlert=true,
                 this.errors = null;
                })
